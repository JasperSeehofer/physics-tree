...
- [x] **UI-01**: Learning Room renders node content phase-by-phase in sequential order, with distinct Leptos components per phase type
...
- [x] **UI-03**: Format switcher allows users to choose between available content formats per phase (reading, video, interactive) with preference persistence
